...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.umo.se/Andra-sprak/Om-UMO/UMO-hakknda'"/>
	...
	<parallel_text xml:lang="swe" location="om-umo.html"/></xsl:variable>
